...
public class ChildTest {
	...
	public void testEquals() {
		try {
			...
			Child c1=new Child("Feigy","Brown",Time.PART_TIME,"none",dob,p,ec);
			Child c2=new Child("Malky","Brown",Time.PART_TIME,"none",dob,p,ec);
			assertEquals(false,c1.isSameChild(c2));
			Child c3=new Child("Feigy","Brown",Time.PART_TIME,"none",dob,p,ec);
